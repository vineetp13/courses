...
//#define NUM_OF_UNIQUE_BRANCHES 1
#define GHR_SIZE 256
#define PHT_SIZE 28672/NUM_OF_UNIQUE_BRANCHES
#define BHT_SIZE 4192 //Branch History Table, of entry size 12 bits 

#define MAX_NUM_OF_BRANCHES 4192
/*
